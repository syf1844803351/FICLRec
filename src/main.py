...
from trainers import FICLRecTrainer
from models import FICLRecModel
...
def main():
    ...
    # model args
    parser.add_argument("--model_name", default="FICLRec", type=str)
    ...
    parser.add_argument("--alpha", type=float, default=0.1, help="weight of high frequency intent contrastive learning task")
    parser.add_argument("--beta", type=float, default=0.1, help="weight of low frequency contrastive learning task")

    # ablation experiments
    parser.add_argument("--cl_mode",type=str,default='hl',help="contrastive mode")
    # {'hl':high-frequency+low-frequency,'h':only high frequency intent contrastive learning,'l':only low frequency contrastive learning}
    ...
    model = FICLRecModel(args=args)
    trainer = FICLRecTrainer(model, train_dataloader,cluster_dataloader, eval_dataloader, test_dataloader, args)
